...
{
	FString AssetIndex = arg.GetTabId().ToString();
...
{
	this->PathToExploresHeader = PathToExploresHeader;
	this->PathToExploresSource = PathToExploresSource;
	this->SelectAssetDatas = SelectAssetDatas;
